...
public class Mutators {
    private static final Gen<Integer> digits3Gen = Gen.frequency(
            Tuple.of(7, Gen.choose(1000, 9999)),
            Tuple.of(3, Gen.choose(1, 99))
    );

    private static final Mutator sexMutator = new Mutator("Sex mutator", nir ->
            Gen.choose(3, 9).map(invalidSex -> concat(invalidSex, nir.toString().substring(1)))
    );

    private static final Mutator yearMutator = new Mutator("Year mutator", nir ->
            Gen.frequency(
    ...
    private static final Mutator departmentMutator = new Mutator("Department mutator", nir ->
            Gen.frequency(
                    Tuple.of(7, Gen.choose(100, 999)),
    ...
    private static final Mutator cityMutator = new Mutator("City mutator", nir ->
    ...
    private static final Mutator serialNumberMutator = new Mutator("Serial Number mutator", nir ->
    ...
    private static final Mutator keyMutator = new Mutator("Key mutator", nir ->
            Gen.choose(0, 97)
                    .filter(x -> x != nir.key())
    ...
    private static final Mutator truncateMutator = new Mutator("Truncate mutator", nir ->
